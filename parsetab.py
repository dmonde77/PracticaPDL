...
_lr_productions = [
  ...
  ('program -> declaracionesYsentencias program','program',2,'p_program_declaracionesYsentencias','Parseador.py',21),
  ('program -> funcion program','program',2,'p_program_funcion','Parseador.py',25),
  ('program -> <empty>','program',0,'p_program_fin','Parseador.py',29),
  ('declaracionesYsentencias -> VAR tipo ID PUNTOYCOMA','declaracionesYsentencias',4,'p_declaraciones','Parseador.py',33),
  ('declaracionesYsentencias -> IF LPAREN expresion RPAREN sentencia','declaracionesYsentencias',5,'p_if','Parseador.py',37),
  ('declaracionesYsentencias -> WHILE LPAREN expresion RPAREN LBRACE interiorFuncion RBRACE','declaracionesYsentencias',7,'p_while','Parseador.py',41),
  ('declaracionesYsentencias -> sentencia','declaracionesYsentencias',1,'p_sentencia','Parseador.py',45),
  ('tipo -> INT','tipo',1,'p_int','Parseador.py',49),
  ('tipo -> STRING','tipo',1,'p_string','Parseador.py',53),
  ('tipo -> BOOLEAN','tipo',1,'p_boolean','Parseador.py',57),
  ('sentencia -> ID asignacion','sentencia',2,'p_sentencia_asignacion','Parseador.py',61),
  ('sentencia -> RETURN sentenciaReturn PUNTOYCOMA','sentencia',3,'p_sentencia_return','Parseador.py',65),
  ('sentencia -> PRINT LPAREN expresion RPAREN PUNTOYCOMA','sentencia',5,'p_sentencia_print','Parseador.py',69),
  ('sentencia -> INPUT LPAREN ID RPAREN PUNTOYCOMA','sentencia',5,'p_sentencia_input','Parseador.py',73),
  ('sentencia -> ID LPAREN argumentosLlamada RPAREN PUNTOYCOMA','sentencia',5,'p_sentencia_funcion','Parseador.py',77),
  ('asignacion -> IGUAL expresion PUNTOYCOMA','asignacion',3,'p_asignacion','Parseador.py',81),
  ('asignacion -> ORIGUAL expresion PUNTOYCOMA','asignacion',3,'p_asignacion_orequal','Parseador.py',85),
  ('sentenciaReturn -> expresion','sentenciaReturn',1,'p_return_expresion','Parseador.py',89),
  ('sentenciaReturn -> <empty>','sentenciaReturn',0,'p_return_fin','Parseador.py',93),
  ('argumentosLlamada -> expresion argumentosLlamadaExtra','argumentosLlamada',2,'p_argumentosLlamada_expresion','Parseador.py',97),
  ('argumentosLlamada -> <empty>','argumentosLlamada',0,'p_argumentosLlamada_fin','Parseador.py',101),
  ('argumentosLlamadaExtra -> COMA expresion argumentosLlamadaExtra','argumentosLlamadaExtra',3,'p_argumentosLlamadaExtra','Parseador.py',105),
  ('argumentosLlamadaExtra -> <empty>','argumentosLlamadaExtra',0,'p_argumentosLlamadaExtra_fin','Parseador.py',109),
  ('funcion -> FUNCTION declaracionArgumentos ID LPAREN argumentos RPAREN LBRACE interiorFuncion RBRACE','funcion',9,'p_funcion','Parseador.py',113),
  ('declaracionArgumentos -> tipo','declaracionArgumentos',1,'p_declaracionArgumentos','Parseador.py',117),
  ('declaracionArgumentos -> <empty>','declaracionArgumentos',0,'p_declaracionArgumentos_fin','Parseador.py',121),
  ('interiorFuncion -> declaracionesYsentencias interiorFuncion','interiorFuncion',2,'p_interiorFuncion','Parseador.py',125),
  ('interiorFuncion -> <empty>','interiorFuncion',0,'p_interiorFuncion_fin','Parseador.py',129),
  ('argumentos -> tipo ID argumentosExtra','argumentos',3,'p_argumentos','Parseador.py',133),
  ('argumentos -> <empty>','argumentos',0,'p_argumentos_fin','Parseador.py',137),
  ('argumentosExtra -> COMA tipo ID argumentosExtra','argumentosExtra',4,'p_argumentosExtra','Parseador.py',141),
  ('argumentosExtra -> <empty>','argumentosExtra',0,'p_argumentosExtra_fin','Parseador.py',145),
  ('expresion -> expresion OR expresionMAYOR','expresion',3,'p_expresion_or','Parseador.py',149),
  ('expresion -> expresionMAYOR','expresion',1,'p_expresion_or_mayor','Parseador.py',153),
  ('expresionMAYOR -> expresionMAYOR MAYOR expresionMAS','expresionMAYOR',3,'p_expresion_mayor','Parseador.py',157),
  ('expresionMAYOR -> expresionMAS','expresionMAYOR',1,'p_expresion_mayor_mas','Parseador.py',161),
  ('expresionMAS -> expresionMAS MAS expresionLiteral','expresionMAS',3,'p_expresion_mas','Parseador.py',165),
  ('expresionMAS -> expresionLiteral','expresionMAS',1,'p_expresion_mas_literal','Parseador.py',169),
  ('expresionLiteral -> ID','expresionLiteral',1,'p_expresionLiteral_id','Parseador.py',173),
  ('expresionLiteral -> INTEGER','expresionLiteral',1,'p_expresionLiteral_integer','Parseador.py',177),
